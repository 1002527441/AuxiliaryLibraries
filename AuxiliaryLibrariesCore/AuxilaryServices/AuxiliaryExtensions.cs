...
namespace AuxiliaryLibraries.Core.AuxilaryServices
{
    ...
    public static class AuxiliaryExtensions
    {
        ...
        /// "firstString".EqualIgnoreCase(secondString)
        /// </summary>
        /// <param name="firstString"></param>
        /// <param name="secondString"></param>
        /// <returns></returns>
        public static bool EqualIgnoreCase(this string firstString, string secondString)
        {
        ...
        /// <summary>
        /// Ignorance Case Sensitive in comparison
        /// var collection = new List<string>(){ "string1", "string2", "string3", "string4" };
        /// var collectionCompareResult = collection.ContainsIgnoreCase("string5");
        /// </summary>
        ...
        /// <param name="separator"></param>
        /// <param name="separatedSize"></param>
        /// <param name="seperatorRtlAlign"></param>
        /// <returns></returns>
        public static string ToCommaDelimited(this float number, string separator = ",", int separatedSize = 3, bool seperatorRtlAlign = true)
        {
            return Convert.ToDecimal(number).ToCommaDelimited(separator, separatedSize, seperatorRtlAlign);
        }
        ...
        /// <param name="seperatorRtlAlign"></param>
        /// <returns></returns>
        public static string ToCommaDelimited(this double number, string separator = ",", int separatedSize = 3, bool seperatorRtlAlign = true)
        {
            return Convert.ToDecimal(number).ToCommaDelimited(separator, separatedSize, seperatorRtlAlign);
        }
        ...
        /// <param name="seperatorRtlAlign"></param>
        /// <returns></returns>
        public static string ToCommaDelimited(this decimal number, string separator = ",", int separatedSize = 3, bool seperatorRtlAlign = true)
        {
            if (number is default(decimal))
            ...
            if (numbers.Count == 2)
                point = CreateCommaSeparatedDecimalPoints(numbers[1], seperatorRtlAlign);

            return !string.IsNullOrEmpty(point) ? $"{num}.{point}" : $"{num}";

            string CreateCommaSeparatedDecimalPoints(string number, bool seperatorRtlAlign = true)
            {
                ...
                {
                    if (seperatorRtlAlign)
                        return decimal.Parse(number.Reverse()).ToString("N0").Reverse();

                    number = '1' + number.Remove(0, 1);
                    var point = decimal.Parse(number).ToString("N0");
                    return $"0{point.Remove(0, 1)}";
                }
                return seperatorRtlAlign ?
                    decimal.Parse(number.Reverse()).ToString("N0").Reverse() :
                    decimal.Parse(number).ToString("N0");
            }
        }
        #endregion
