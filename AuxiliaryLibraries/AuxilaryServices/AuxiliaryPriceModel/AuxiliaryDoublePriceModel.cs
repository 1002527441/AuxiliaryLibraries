...
namespace AuxiliaryLibraries
{
    ...
    public class AuxiliaryDoublePriceModel : AuxiliaryBasicPriceModel<double>
    {
        ...
        public AuxiliaryDoublePriceModel(double price, Currency priceBaseCurrency = Currency.IRR, Currency priceTargetCurrency = Currency.Toman, bool metricSystem = false)
        {
            try
            {
        ...
        /// <param name="metricSystem">If you need to receive the price as Mili, Micro, Nano, and ... set it as true</param>
        /// <returns></returns>
        protected override AuxiliaryBasicPriceModel<double> Calculate(double price, bool metricSystem = false)
        {
        ...
        protected override void CalculateIntegers(double price, int power, ref double priceShortFormat, ref string priceCurrency, ref string priceDescriptyion, bool metricSystem)
        {
        ...
        /// <param name="power"></param>
        /// <returns></returns>
        protected override double Round(double price, double powerd, int power)
        {
